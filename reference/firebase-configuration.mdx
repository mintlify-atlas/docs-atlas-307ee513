---
title: "Firebase Configuration for Webtile"
sidebarTitle: "Firebase Config"
description: "All six VITE_FIREBASE_* environment variables required to connect Webtile to a Firebase project, with instructions for finding each value."
---
